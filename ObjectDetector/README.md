...
<h4 align="center">An object detector <a href="https://jotrocken.blog/" target="_blank"></a>.</h4>
...
There is a high demand in high-performance real-time object detection applications.
...
1. Clone the repo
   ```sh
   git clone git@github.com:Kataglyphis/ObjectDetector.git
   ```
