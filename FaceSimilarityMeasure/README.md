# FaceSimilarityMeasure
<h1 align="center">
  <br>
  <a href="https://jotrocken.blog/"><img src="images/logo.png" alt="OpenGLEngine" width="200"></a>
  <br>
  Get a score for face similarity measure
  <br>
</h1>

<h4 align="center">A face similarity measure application <a href="https://jotrocken.blog/" target="_blank"></a>.</h4>
...
1. Clone the repo
   ```sh
   git clone git@github.com:Kataglyphis/FaceSimilarityMeasure.git
   ```
