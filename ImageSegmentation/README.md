...
<h4 align="center">Different Approaches in image segmentation collected. <a href="https://jotrocken.blog/" target="_blank"></a>.</h4>
...
1. Clone the repo
   ```sh
   git clone git@github.com:Kataglyphis/ImageSegmentation.git
   ```
